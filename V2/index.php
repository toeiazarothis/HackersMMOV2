...
<body>
    ...
    <!--  -->
    <section id="Presentation" class="presentation bg-darkest-gray">
      <div class="container">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Pour ne jamais faiblir face au imprevu du destin.</p>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Ce donner des objectifs (seul ou a plusieur) pour ce depasser.</p>
                                <a href="#" class="btn btn-light">Learn More</a>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Defendre toutes les personne qui en feront la demande.</p>
                                <a href="#" class="btn btn-light">Learn More</a>
                            </div>
                        </div>
                    </div>
